...
Options:
  ...
  --provider <name>    Provider for leslie-image-gen batch tasks (default: replicate)
  --model <id>         Explicit model for leslie-image-gen batch tasks (default: resolved by leslie-image-gen config/env)
