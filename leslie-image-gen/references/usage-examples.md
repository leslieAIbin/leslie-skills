...
- Typically 5–10× slower than direct OpenAI / Google API calls (except on cache hits). Tune via `LESLIE_CODEX_IMAGEGEN_TIMEOUT_MS`, `LESLIE_CODEX_IMAGEGEN_RETRIES`, and `LESLIE_CODEX_IMAGEGEN_CACHE_DIR`.
