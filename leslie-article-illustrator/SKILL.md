---
name: leslie-article-illustrator
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.leslie-skills/leslie-article-illustrator/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/leslie-skills/leslie-article-illustrator/EXTEND.md` | XDG |
| 3 | `$HOME/.leslie-skills/leslie-article-illustrator/EXTEND.md` | User home |
...
- **Reconfigure interactively** — delete EXTEND.md (or ask "reconfigure leslie-article-illustrator preferences" / "重新配置"). The next run re-triggers first-time setup.
