...
/leslie-article-illustrator path/to/article.md

# Specify type
/leslie-article-illustrator path/to/article.md --type infographic

# Specify style
/leslie-article-illustrator path/to/article.md --style blueprint

# Combine type and style
/leslie-article-illustrator path/to/article.md --type flowchart --style notion

# Specify density
/leslie-article-illustrator path/to/article.md --density rich

# Generate up to 4 images in parallel after prompts are saved
/leslie-article-illustrator path/to/article.md --batch-size 4

# Direct content input (paste mode)
/leslie-article-illustrator
[paste content]
```
...
```bash
/leslie-article-illustrator api-design.md --type infographic --style blueprint
```

**Same thing with preset**:
```bash
/leslie-article-illustrator api-design.md --preset tech-explainer
```

**Personal story**:
```bash
/leslie-article-illustrator journey.md --preset storytelling
```

**Tutorial with steps**:
```bash
/leslie-article-illustrator how-to-deploy.md --preset tutorial --density rich
```

**Opinion article with poster style**:
```bash
/leslie-article-illustrator opinion.md --preset opinion-piece
```

**Preset with override**:
```bash
/leslie-article-illustrator article.md --preset tech-explainer --style notion
```
