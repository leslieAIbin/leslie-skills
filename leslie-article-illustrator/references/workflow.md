...
test -f .leslie-skills/leslie-article-illustrator/EXTEND.md && echo "project"
test -f "${XDG_CONFIG_HOME:-$HOME/.config}/leslie-skills/leslie-article-illustrator/EXTEND.md" && echo "xdg"
test -f "$HOME/.leslie-skills/leslie-article-illustrator/EXTEND.md" && echo "user"
```

```powershell
# PowerShell (Windows)
if (Test-Path .leslie-skills/leslie-article-illustrator/EXTEND.md) { "project" }
$xdg = if ($env:XDG_CONFIG_HOME) { $env:XDG_CONFIG_HOME } else { "$HOME/.config" }
if (Test-Path "$xdg/leslie-skills/leslie-article-illustrator/EXTEND.md") { "xdg" }
if (Test-Path "$HOME/.leslie-skills/leslie-article-illustrator/EXTEND.md") { "user" }
```
...
|------------------------|--------|
| Yes (e.g., leslie-image-gen with Google) | Pass reference images via `--ref` |
