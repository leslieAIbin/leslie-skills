...
description: First-time setup flow for leslie-article-illustrator preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.leslie-skills/leslie-article-illustrator/EXTEND.md` | Current project |
| User | `~/.leslie-skills/leslie-article-illustrator/EXTEND.md` | All projects |
