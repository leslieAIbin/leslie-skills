...
description: First-time setup flow for leslie-post-to-wechat preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.leslie-skills/leslie-post-to-wechat/EXTEND.md` | Current project |
| User | `~/.leslie-skills/leslie-post-to-wechat/EXTEND.md` | All projects |
