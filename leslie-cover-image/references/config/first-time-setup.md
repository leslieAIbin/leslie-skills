...
description: First-time setup flow for leslie-cover-image preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.leslie-skills/leslie-cover-image/EXTEND.md` | Current project |
| User | `~/.leslie-skills/leslie-cover-image/EXTEND.md` | All projects |
