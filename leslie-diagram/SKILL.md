...
This customized copy intentionally remains a local SVG generator. It does not call ZenMux, does not require an API key, and is the preferred path for architecture, flow, sequence, and data-flow diagrams where editable vector output is more useful than a raster image.
